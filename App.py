...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # 홈 맨 위 가운데 로고
        homeLogoBtn = tk.Button(topFrame, image=self.homeLogoImg, bd=0, background="black",  activebackground="black", command=self.controller.show)
        homeLogoBtn.place(x=195, y=18)

        # 홈 맨 위 오른쪽
        homeRightBtn = tk.Button(topFrame, image=self.homeRightImg, bd=0, background="black", activebackground="black", command=self.controller.show)
...
class Following_FeedPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        homeLeftBtn = tk.Button(topFrame, image=self.homeLeftImg, bd=0, background="black", activebackground="black", command=lambda: controller.show_frame(HomePage))
        ...
        followingBtn = tk.Button(topFrame, image=self.homeLogoImg, bd=0, background="black",  activebackground="black", command=self.controller.show)
